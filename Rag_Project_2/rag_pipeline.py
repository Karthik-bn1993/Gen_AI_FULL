...
# [ "Leave policy is 20 days", "Employees must apply in portal"]
...
# Leave policy is 20 days Employees must apply in portal
    ...
    5. Dont answer anything except the HR Policy docs.
    ...
    response = client.chat.completions.create(
        ...
        temperature=0.3,   # 🔥 less randomness (good for RAG)
